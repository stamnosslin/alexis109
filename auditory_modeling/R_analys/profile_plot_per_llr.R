...
if(savefig == 1) {
  pdf("R_analys/profile_fig_per_llr.pdf", width = 15/2.54, height = 23/2.54, paper = 'letter')
}

# Open png 
if(savefig == 2) {
  png("R_analys/profile_fig_per_llr.png", units = "in", res = 600, width = 15/2.54, height = 23/2.54)
}
## -----------------------------------------------------------------------------
